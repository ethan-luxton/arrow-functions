...
// Student.prototype.greeting = () => {return `Hi, my name is ${joe.name}`;};
// Doesn't break??? Just have to swap this.name with joe.name
...
// Console logs Window and all of its contents.
...
//      When joe.scope is invoked, 'this' refers to the object of Joe that was created prior. With the properties of name, age, and hometown.
// 2. What is "this" when joe.scopeArrow() is invoked?
//      When joe.scopeArrow is invoked, it is referring to the page object (Window object of the entire webpage) and all of its contents. 
 // 3. Explain why "this" is different when an arrow function is used.
//      When using the arrow function, among other cases, 'this' refers to the default object, in this case it is the window or entire page. When using it in the context of a regular function, it refers to the student, in this case: Joe.